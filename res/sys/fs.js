...
const fs_readfile = function(path, call, catc) {
    $.ajax({
        type: "GET",
        url: path,
        success: call,
    ...
    fs_readfile(path, (data) => {
        ...
        //try {
            ...
            if(ex === 'js') {
                ...
                runWindow('/res/apps/viewimg/main.js', path);
                return true;
            } else if(ex === 'jpg') {
                runWindow('/res/apps/viewimg/main.js', path);
                return true;
                ...
                runWindow('/res/apps/browser/main.js', { type: 'path', data: path });
                return true;
            } else if(ex === 'link') {
                runWindow(data);
                return true;
            } else {
                runWindow('/res/apps/notepad/main.js', path);
                return true;
            }
        //} catch { window.location = '/res/bsod.html'; }
